\graphicspath{{pic/be/}}
\chapter{Appendix2: Be stars from Ond\v rejov}
List of 46 objects from Ond\v rejov used as training set in data
mining process described in section \ref{sec:spectral}.
